...
#	sleep = sleep + 0.000001
	...
	if toggle:
		req.add_plane(planes[1], fb[fb_ind], crtc, dst=(0, 0, fbX, 1080), zpos=1)
		req.add_plane(planes[2], None, None, zpos=2)
		req.add_plane(planes[3], None, None, zpos=3)
	else:
		req.add_plane(planes[1], red_fb, crtc, dst=(0, 0, fbX, 1080), zpos=1)
		req.add_plane(planes[2], green_fb, crtc, dst=(0, 0, fbX, 1080), zpos=2)
		req.add_plane(planes[3], fb[fb_ind], crtc, dst=(0, 0, fbX, 1080), zpos=3)
